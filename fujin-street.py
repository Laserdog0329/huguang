...
# 1. 页面基本设置与标题
st.set_page_config(page_title="湖映福津", page_icon="🏘️")
...
with tab1:
    ...
    with col1:
        search_text = st.text_input("🔍 搜索店名 (例如: 包子)")
    with col2:
        category = st.selectbox("📁 按类型筛选", ["全部", "餐饮", "五金", "医疗"])
    ...
    with showcase_col1:
        st.info("🥟 **福津包子铺**\n\n社区老字号，每天早上6点准时出炉新鲜肉包。对社区老人有专属八折优惠！")
    with showcase_col2:
